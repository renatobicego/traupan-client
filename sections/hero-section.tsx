...
const HeroSection = () => {
  return (
    <section className="flex items-start w-full justify-between min-h-[81vh] relative z-10">
      <div className="flex flex-col items-start justify-center gap-4 text-secondary w-1/2 my-16">
